        ...
        <form className='add-item-form'>
          {error && errorMessage ? <span className='register-error'>{errorMessage}</span> : null}
            ...
            <div className='add-item-input-container'>
              ...
              <input onChange={(e) => setNewTargetDate(e.target.value)} type='text' id='add-item-target-date' className='add-item-input' placeholder='When should this goal be completed by?' onFocus={(e) => (e.target.type = 'date')} onClick={(e) => (e.target.type = 'date')} onBlur={(e) => (e.target.type = 'text')} />
              {/* <input onChange={(e) => setNewTargetDate(e.target.value)} type='date' id='add-item-target-date' className='add-item-input' placeholder='yyyy-mm-dd' /> */}
            </div>
            <div className='add-item-input-container'>
